...
_INSTRUCTIONS = (
    ...
    "les planches cotées) -> "
    "extraire_page(pdf_id=...) pour chaque page retenue, obtenir extraction_id : "
    "role='garde' pour la page de la vue 3D (seul rôle qui produit l'image de "
    "la vue 3D, même si cette page porte aussi le tableau specs), "
    "role='planche' pour chaque planche cotée, role='specs' uniquement pour "
    "une page de specs SANS vue 3D (ce rôle ne produit aucune image) -> "
    "traduire_mots(extraction_id=...) avec role='planche' sur chaque planche "
    "et role='specs' sur la page du tableau specs (y compris quand elle a été "
    "extraite avec role='garde') "
    "-> assembler_pptx(planches=[{extraction_id}, ...], view3d={extraction_id} "
    "de la page extraite avec role='garde' — sans view3d la page specs sort "
    "SANS vue 3D, specs={extraction_id} OBLIGATOIRE de la page traduite avec "
    "role='specs' ; vue 3D et tableau specs sur la même page : passez le MÊME "
    "extraction_id à view3d et à specs) (obtenir pptx_id) "
